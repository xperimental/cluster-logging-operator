...
func ResourceNames(clf obsv1.ClusterLogForwarder) *ForwarderResourceNames {
	...
	return &ForwarderResourceNames{
		...
		ServiceAccount:                   clf.Spec.ServiceAccountName.Name,
		InternalLogStoreSecret:           clf.Spec.ServiceAccountName.Name + "-default",
		ServiceAccountTokenSecret:        clf.Spec.ServiceAccountName.Name + "-token",
	}
}
